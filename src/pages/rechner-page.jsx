...
import { Droplets, Zap, Euro, TrendingDown, Leaf } from 'lucide-react';
...
export default function ElektroAutoRechner() {
  ...
  const berechnung = useMemo(() => {
    ...
    if (expertenModus) {
      // Gewichteter Durchschnittspreis basierend auf Ladeanteilen
    ...
    // Wartungskosten (E-Auto ca. 35% günstiger)
    ...
    // CO2-Emissionen (kg)
    const co2Elektro = (kmGesamt / 100) * verbrauchElektro * 0.4; // 400g CO2/kWh deutscher Strommix
    const co2Verbrenner = (kmGesamt / 100) * verbrauchVerbrenner * 2.37; // 2370g CO2/Liter Benzin
    ...
    return {
      ...
      co2ErsparnisProJahr: (co2Ersparnis / 1000 / nutzungsdauer).toFixed(2),
      co2ElektroProMonat: (co2Elektro / 1000 / nutzungsdauer / 12).toFixed(2),
      co2VerbrennerProMonat: (co2Verbrenner / 1000 / nutzungsdauer / 12).toFixed(2),
      co2ErsparnisProMonat: (co2Ersparnis / 1000 / nutzungsdauer / 12).toFixed(2)
    };
  }, [kaufpreisElektro, kaufpreisVerbrenner, jahreskilometer, strompreis, benzinpreis, 
      verbrauchElektro, verbrauchVerbrenner, nutzungsdauer, staatlicheFoerderung,
      versicherungElektroProJahr, versicherungVerbrennerProJahr, steuerElektroProJahr, steuerVerbrennerProJahr,
      expertenModus, strompreisZuhause, strompreisOeffentlich, strompreisPV, anteilZuhause, anteilOeffentlich, anteilPV,
      parkgebuehrenErsparnis, thgQuote]);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-green-50 p-4 md:p-8">
      ...
      <div className="max-w-6xl mx-auto">
        {/* Rechner Section */}
        <div id="rechner" className="bg-white rounded-2xl shadow-2xl p-6 md:p-8 mb-6">
          ...
          <div className="bg-gray-50 rounded-xl p-6 mb-8">
            <h3 className="text-xl font-bold text-gray-800 mb-4">Allgemeine Parameter</h3>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-8">
            ...
            <div className="bg-blue-50 rounded-xl p-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="text-2xl font-bold text-gray-800">Elektroauto</h2>
              </div>
            ...
            <div className="bg-orange-50 rounded-xl p-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h2 className="text-2xl font-bold text-gray-800">Verbrenner</h2>
              </div>
          ...
          {expertenModus && (
            <div className="bg-purple-50 border-2 border-purple-200 rounded-xl p-6 mb-8">
              <h3 className="text-xl font-bold text-gray-800 mb-6">Erweiterte Einstellungen</h3>
          ...
          <div className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-blue-100 rounded-xl p-6">
                <h3 className="text-xl font-bold text-blue-900 mb-4">Elektroauto</h3>
              ...
              <div className="bg-orange-100 rounded-xl p-6">
                <h3 className="text-xl font-bold text-orange-900 mb-4">Verbrenner</h3>
                <div className="space-y-3 text-base">
                  <div className="flex justify-between">
                    <span className="text-gray-700">Kaufpreis:</span>
            ...
            <div className={`rounded-xl p-8 ${berechnung.ersparnisPositiv ? 'bg-green-100' : 'bg-red-100'}`}>
              <div className="flex items-center gap-3 mb-8">
                <TrendingDown className={`w-9 h-9 ${berechnung.ersparnisPositiv ? 'text-green-600' : 'text-red-600'}`} />
              ...
              <div className="space-y-6">
                ...
                <div className="flex justify-between items-center bg-white rounded-lg p-6">
                  ...
                  <p className={`text-5xl font-bold ${berechnung.ersparnisPositiv ? 'text-green-700' : 'text-red-700'}`}>
            ...
            <div className="bg-yellow-50 rounded-xl p-8">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-3xl font-bold text-gray-800">CO₂-Bilanz über {nutzungsdauer} Jahre</h3>
              </div>
        ...
        <footer className="border-t-2 border-gray-200 pt-8">
          <div className="max-w-6xl mx-auto">
            {/* Quellen */}
            <div className="mb-8">
              <h3 className="text-xl font-bold text-gray-800 mb-4">Quellen</h3>
